        ...
        <div className="grid flex-1 items-center gap-14 py-16 lg:grid-cols-2">
          <section>
            ...
            <div className="mt-9 flex flex-col gap-4 sm:flex-row">
              ...
              <Link
                href="/dashboard"
                className="inline-flex items-center justify-center gap-3 rounded-2xl border border-pink-100 bg-white px-7 py-4 text-sm font-bold text-pink-500 shadow-md shadow-pink-100 hover:bg-pink-50"
              >
                <ListChecks size={18} />
                Ir al dashboard
              </Link>
